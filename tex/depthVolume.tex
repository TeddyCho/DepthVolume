...
Graphs are located in Dropbox\footnote{https://www.dropbox.com/sh/9m485w2yvkczkle/AACP6PtrgDxGnU7Vd8I2ofYla?dl=0}.
\begin{figure}[H]
\centering
\includegraphics[width=120mm]{{./../output/scatter}.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=120mm]{{./../output/scatterLog}.png}
\caption{The above graph, logged.}
\end{figure}
\end{document}